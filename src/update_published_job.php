        ...
        <div class="card-body">
          <form id="update_published_job_form" method="POST" action="">
            ...
            <div class="form-group mb-3">
              ...
              <input type="text" name="job_title" class="form-control form-control-sm" value="<?php echo $row['job_title']; ?>">
                ...
                <div class="me-4">
                  <div class="form-group">
                    ...
                    <div class="form-check mt-1">
                      <input id="frontend_checked_tag" type="checkbox" class="it_tag_length form-check-input" name="it_tag[0]" value="frontend" <?php if ($row['frontend_tag'] != null || $row['frontend_tag'] != '') {
                                                                                                                                                    echo 'checked';
                                                                                                                                                  } ?>>
                      <label class="form-check-label" for="it_branch">Front-end Development</label>
                    </div>
                    <div class="form-check mb-2">
                      <input id="backend_checked_tag" type="checkbox" class="it_tag_length form-check-input" name="it_tag[1]" value="backend" <?php if ($row['backend_tag'] != null || $row['backend_tag'] != '') {
                                                                                                                                                    echo 'checked';
                                                                                                                                                  } ?>>
                      <label class="form-check-label" for="it_branch">Back-end Development</label>
                    </div>
                    <div class="form-check mb-2">
                      <input id="fullstack_checked_tag" type="checkbox" class="it_tag_length form-check-input" name="it_tag[2]" value="fullstack" <?php if ($row['fullstack_tag'] != null || $row['fullstack_tag'] != '') {
                                                                                                                                                    echo 'checked';
                                                                                                                                                  } ?>>
                      <label class="form-check-label" for="it_branch">Fullstack Development</label>
                    </div>
                    <div class="form-check mb-2">
                      <input id="qa_checked_tag" type="checkbox" class="it_tag_length form-check-input" name="it_tag[3]" value="qa" <?php if ($row['qa_tag'] != null || $row['qa_tag'] != '') {
                                                                                                                                                    echo 'checked';
                                                                                                                                                  } ?>>
                      <label class="form-check-label" for="it_branch">Quality Assurance</label>
                    </div>
                    <div class="form-check mb-2">
                      <input id="mobdev_checked_tag" type="checkbox" class="it_tag_length form-check-input" name="it_tag[4]" value="mobdev" <?php if ($row['mobdev_tag'] != null || $row['mobdev_tag'] != '') {
                                                                                                                                                    echo 'checked';
                                                                                                                                                  } ?>>
                      <label class="form-check-label" for="it_branch">Mobile Development</label>
                    </div>
                    <div class="form-check mb-2">
                      <input id="ux_ui_checked_tag" type="checkbox" class="it_tag_length form-check-input" name="it_tag[5]" value="ux/ui" <?php if ($row['ux_ui_tag'] != null || $row['ux_ui_tag'] != '') {
                                                                                                                                                    echo 'checked';
                                                                                                                                                  } ?>>
            ...
            <div class="form-group">
              ...
              <textarea name="job_description" rows="8" class="form-control"><?php echo $row['job_description']; ?></textarea>
              <p id="job_description_response_text" class="m-0"></p>
            </div>
            <button type="submit" name="publish_submit" class="btn btn-primary mt-3" value="<?php echo $row['id']; ?>">Update</button>
          </form>
        </div>
      </div>
    </div>
