          ...
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              ...
              <a class="cursor-pointer nav-link p-0 pe-1 ms-2 ms-sm-0" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <span id="greetings_first_name" class="d-none d-sm-inline"><?php echo $profile->name; ?></span>
              ...
              <ul id="job_seeker_navbar_data" class="dropdown-menu dropdown-menu-end dropdown-menu-sm-start" aria-labelledby="navbarDarkDropdownMenuLink">
