$(function () {
  // Messages
  // Sending message from HR dashboard
  ...
  // Reply message from employee dashboard
  ...
  // Reply message from HR dashboard to job seeker
  ...
  // Reply message from HR dashboard to company
  ...
  // Send message from HR to Company
