      ...
      <ul id="view_published_jobs" class="list-group-flush">
        ...
        <?php foreach ($job_data->display_jobs_company('N') as $value) : ?>
          <li class="job-li list-group-item py-3">
            ...
            <p class="d-none"><b>Description: </b><?php echo $value['job_description']; ?> </p>
            <div class="d-flex">
              ...
              <button id="activate_published_job" class="btn btn-outline-success d-flex align-items-center btn-sm me-2" value="<?php echo $value['id']; ?>" data-bs-animation="false" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Your publish will be active!">
                Turn on
              ...
              <span class="js-remove-job-from-db tooltip-icon" data-bs-animation="false" data-bs-toggle="tooltip" data-bs-placement="left" title="Your publish will be DELETED!">
                <input type="hidden" value="<?php echo $value['id']; ?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="text-danger ms-2 bi bi-trash" viewBox="0 0 16 16">
