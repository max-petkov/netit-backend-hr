  ...
  <div class="card shadow-lg rounded">
    <div class="card-header">
      ...
      <ul class="nav nav-tabs card-header-tabs">
        ...
        ?>
        <li class="nav-item">
          <a href="#" class="nav-link active">New applicants (<?php echo $stmt->rowCount(); ?>)</a>
        </li>
        <li class="nav-item">
          ...
          <?php foreach ($row as $key => $value) : ?>
            <tr class="js-applicants-data">
              ...
              <td id="is_approved" class="text-center">
                <div class="d-flex justify-content-center">
                  <button class="btn btn-success btn-sm me-2" value="Y">Yes</button>
                  <button class="btn btn-danger btn-sm" value="N">No</button>
                </div>
              </td>
            </tr>
          <?php endforeach; ?>
