          ...
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDarkDropdownMenuLink">
                ...
                <li>
                  <a class="message_icon dropdown-item xsm-text-class" href="#">View applicants<span
                      class="badge rounded-pill bg-danger ms-1">4</span>
                  </a>
                </li>
                <div class="dropdown-divider"></div>
          ...
          <li class="nav-item">
            <a href="#" class="message_icon nav-link d-flex align-items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                class="me-1 bi bi-person-badge" viewBox="0 0 16 16">
                ...
                <div class="d-flex mb-2">
                  <button class="me-3 btn btn-outline-primary btn-sm d-flex align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                      class="me-1 bi bi-chevron-double-right" viewBox="0 0 16 16">
                      <path fill-rule="evenodd"
                  ...
                  <button class="btn btn-outline-primary btn-sm d-flex align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                      class="me-1 bi bi-reply" viewBox="0 0 16 16">
                      <path
                  ...
                  <div class="card-body">
                    <div class="form-group mb-2">
                      ...
                      <input type="text" class="form-control form-control-sm" name="first_name"
                        value="$employee_last_name" disabled>
                    </div>
                    <div class="form-group mb-2">
                      <label for="last_name">Last name</label>
                      <input type="text" class="form-control form-control-sm" name="last_name"
                        value="$employee_first_name" disabled>
                    </div>
                    <div class="form-group mb-2">
                      <label for="email">Email</label>
                      <input type="email" class="form-control form-control-sm" name="email" value="$employee_email"
                        disabled>
                    </div>
                    <div class="form-group mb-2">
                      <label for="website_employee">Website</label>
                      <input type="text" class="form-control form-control-sm" name="website_employee"
                        value="$employee_website" disabled>
                    </div>
                  ...
                  <div class="card-body">
                    <form action="#">
                      <div class="form-group mb-2">
                        ...
                        <input type="email" class="form-control form-control-sm" name="" value="$company_email"
                          disabled>
                      </div>
                      <div class="form-group mb-2">
                        <label for="to">To:</label>
                        <input type="email" class="form-control form-control-sm" name="" value="$candidate_email"
                          disabled>
                      </div>
                      <div class="form-group mb-2">
                        <label for="subject">Subject:</label>
                        <input type="text" class="form-control form-control-sm" name=""
                          value="Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fugit, vitae.">
                      </div>
                      <div class="form-group">
