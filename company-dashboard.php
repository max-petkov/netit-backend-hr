        ...
        <div class="collapse navbar-collapse justify-content-end">
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              <a id="greetings" class="nav-link dropdown-toggle" href="#" id="navbarDarkDropdownMenuLink" role="button"
                data-bs-toggle="dropdown" aria-expanded="false">
              </a>
              <ul class="dropdown-menu" aria-labelledby="navbarDarkDropdownMenuLink">
                <li class="dropdown-item xsm-text-class text-center">Your are logged in as<br><b
                    class="xsm-text-class">$company_username</b>
                </li>
                ...
                <li>
                  <a class="message_icon dropdown-item xsm-text-class" href="#">Messages<span
                      class="badge rounded-pill bg-danger ms-1">3</span>
                  </a>
                </li>
                <div class="dropdown-divider"></div>
                <li id="publish_job_button">
                  <a class="dropdown-item xsm-text-class d-flex align-items-center" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                      class="me-1 bi bi-upload" viewBox="0 0 16 16">
                      <path
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a href="#" class="message_icon nav-link d-flex align-items-center">
              <svg id="envelope_close" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                class="me-1 envelope_closed bi bi-envelope" viewBox="0 0 16 16">
                <path
                  d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2zm13 2.383l-4.758 2.855L15 11.114v-5.73zm-.034 6.878L9.271 8.82 8 9.583 6.728 8.82l-5.694 3.44A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.739zM1 11.114l4.758-2.876L1 5.383v5.73z" />
              </svg>
              <svg id="envelope_open" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                class="me-1 d-none bi bi-envelope-open" viewBox="0 0 16 16">
                <path
    ...
    <div class="d-flex justify-content-between mt-4">
      <div class="ms-3">
        ...
        <button class="btn btn-primary btn-sm d-flex align-items-center">
          <svg class="me-1" xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
      ...
      <form action="#" method="POST" class="row edit-profile pb-3">
        ...
        <div class="form-group row mb-3 pe-0">
          <div class="form-group col-0 col-sm-6 pe-0 pe-sm-2">
            ...
            <input type="text" class="form-control form-control-sm" name="first_name" value="$company_name">
          </div>
          <div class="form-group col-0 pe-0 col-sm-6">
            <label for="last_name">Slogan</label>
            <input type="text" class="form-control form-control-sm" name="last_name" value="$company_slogan">
          </div>
        </div>
        ...
        <div class="form-group row mb-3 pe-0">
          <div class="form-group col-0 col-sm-6 pe-0 pe-sm-2">
            ...
            <input type="text" class="form-control form-control-sm" name="address_employee" value="$company_address">
          </div>
          <div class="form-group col-0 col-sm-6 pe-0">
            <label for="website_employee">Website</label>
            <input type="text" class="form-control form-control-sm" name="website_employee" value="$company_website">
          </div>
        </div>
        ...
        <div class="form-group row mb-3 pe-0">
          <div class="form-group col-0 col-sm-6 pe-0 pe-sm-2">
            ...
            <input type="text" class="form-control form-control-sm" name="username1" value="$employee_username"
              disabled>
          </div>
          <div class="form-group col-0 col-sm-6 pe-0">
        ...
        <div class="form-group mb-3">
          ...
          <textarea name="company_history" class="form-control form-control-sm" id="company_history" rows="4"
            placeholder="">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Possimus praesentium nostrum earum quod libero pariatur.
          </textarea>
        </div>
        <div class="form-group mb-3">
          <label for="company_mission">Company mission</label>
          <textarea name="company_mission" class="form-control form-control-sm" id="company_mission" rows="4"
            placeholder="">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Possimus praesentium nostrum earum quod libero pariatur.
          </textarea>
        </div>
        <div class="form-group mb-3">
          <label for="company_target">Company target</label>
          <textarea name="company_target" class="form-control form-control-sm" id="company_target" rows="4"
            placeholder="">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Possimus praesentium nostrum earum quod libero pariatur.
          </textarea>
        </div>
        <div class="form-group">
          <label for="company_objective">Company objective</label>
          <textarea name="company_objective" class="form-control form-control-sm" id="company_objective" rows="4"
            placeholder="">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Possimus praesentium nostrum earum quod libero pariatur.
          </textarea>
        </div>
    </div>
            ...
            <tbody>
              <tr class="table-success">
                ...
                <td><button class="btn btn-outline-primary btn-sm d-flex">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                      class="me-1 bi bi-download" viewBox="0 0 16 16">
                      <path
                        d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z" />
                      <path
        ...
        <div class="card-body">
          ...
          <form method="POST" action="#">
            ...
            <div class="form-group">
              ...
              <textarea name="job_description" id="" cols="30" rows="8"
    ...
    <div class="row">
      <div class="col-0 col-md-9 mx-auto">
        <div class="mb-3 d-flex">
          <img src="https://www.logolynx.com/images/logolynx/2a/2ad00c896e94f1f42c33c5a71090ad5e.png" class="me-1"
            width="80px" alt="">
        ...
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Accusamus, numquam! Voluptate, perferendis.
          Distinctio explicabo ipsam facere unde, laboriosam, deleniti libero est nam quidem aut vitae. Ex, excepturi
          saepe perferendis enim vel commodi ipsam dolorum numquam suscipit illum recusandae. Cumque in quia distinctio
          vel recusandae autem quos iure odit sequi cum.</p>

        <ul class="mb-0">
          <h4>Company description:</h4>
          <li class="mb-3">
            Company history: Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perferendis rerum nisi corporis
            quam quo iste saepe at cum animi adipisci! Nihil dolor doloremque esse, fugit assumenda vel asperiores
            perferendis similique.
          </li>
          <li class="mb-3">
            Company mission: Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perferendis rerum nisi corporis
            quam quo iste saepe at cum animi adipisci! Nihil dolor doloremque esse, fugit assumenda vel asperiores
            perferendis similique.
          </li>
          <li class="mb-3">
            Objectives: An outline of what you want to accomplish in the immediate future based on the data in the rest
            of the business plan as well as future growth goals
          </li>
          <li>
