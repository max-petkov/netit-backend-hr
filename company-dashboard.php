...
<body>
        ...
        <div class="company_branches">
          <div class="form-group mb-3">
            ...
            <div class="form-check my-2">
              <input id="frontend_checked_status" type="checkbox" class="checkbox_length form-check-input" name="it_branch[0]" value="frontend" <?php if($frontend_branch != null || $frontend_branch != ''){echo 'checked';} ?>>
              <label class="form-check-label" for="it_branch">Front-end Development</label>
            </div>
            <div class="form-check mb-2">
              <input id="backend_checked_status" type="checkbox" class="checkbox_length form-check-input" name="it_branch[1]" value="backend" <?php if($backend_branch != null || $backend_branch != ''){echo 'checked';} ?>>
              <label class="form-check-label" for="it_branch">Back-end Development</label>
            </div>
            <div class="form-check mb-2">
              <input id="fullstack_checked_status" type="checkbox" class="checkbox_length form-check-input" name="it_branch[2]" value="fullstack" <?php if($fullstack_branch != null || $fullstack_branch != ''){echo 'checked';} ?>>
              <label class="form-check-label" for="it_branch">Fullstack Development</label>
            </div>
            <div class="form-check mb-2">
              <input id="qa_checked_status" type="checkbox" class="checkbox_length form-check-input" name="it_branch[3]" value="qa" <?php if($qa_branch != null || $qa_branch != ''){echo 'checked';} ?>>
              <label class="form-check-label" for="it_branch">Quality Assurance</label>
            </div>
            <div class="form-check mb-2">
              <input id="mobdev_checked_status" type="checkbox" class="checkbox_length form-check-input" name="it_branch[4]" value="mobdev" <?php if($mobdev_branch != null || $mobdev_branch != ''){echo 'checked';} ?>>
              <label class="form-check-label" for="it_branch">Mobile Development</label>
            </div>
            <div class="form-check mb-2">
              <input id="ux_ui_checked_status" type="checkbox" class="checkbox_length form-check-input" name="it_branch[5]" value="ux/ui" <?php if($ux_ui_branch != null || $ux_ui_branch != ''){echo 'checked';} ?>>
  ...
  <ul id="view_published_jobs" class="container">
    <?php
    $db = new PDO("mysql:host=localhost;dbname=monster_hr_db", "root", '');
    $sql = ("SELECT * FROM tb_published_jobs WHERE is_active='Y' AND company_id='{$_SESSION['company_id']}' ORDER BY id DESC");
    $stmt = $db->query($sql);
    $stmt->execute();
      ...
      <li class="job-li list-group-item py-3">
        ...
        <span class="badges mt-1">
          ...
          <div class="d-flex">
            ...
            <button class="btn btn-warning d-flex align-items-center btn-sm me-2">
              <svg class="me-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-double-right" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M3.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L9.293 8 3.646 2.354a.5.5 0 0 1 0-.708z" />
                <path fill-rule="evenodd" d="M7.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L13.293 8 7.646 2.354a.5.5 0 0 1 0-.708z" />
              </svg>
