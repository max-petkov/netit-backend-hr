        ...
        <div class="collapse navbar-collapse justify-content-end order-1 order-sm-0">
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              ...
              ?>
              <a class="nav-link cursor-pointer p-0 pe-1 ms-2 ms-sm-0" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <span id="greetings" class="d-none d-sm-inline"></span>
                <span id="greetings_company_name" class="d-none d-sm-inline"><?php echo $profile->name; ?></span>
